...
private class URLQueryItemEncoderKeyedContainer<Key: CodingKey>: KeyedEncodingContainerProtocol {
    ...
    private func store(value: Any, key: String) {
        let describedValue = String(describing: value)
        let queryItem = URLQueryItem(name: key, value: describedValue)
        encoder.queryItems.append(queryItem)
    }
    ...
    func encode(_ value: Bool, forKey key: Key) throws {
        store(value: value, key: key.stringValue)
    }
